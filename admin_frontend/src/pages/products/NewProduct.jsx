...
function NewProduct() {
  ...
  const [data, setData] = useState({
    product_Name: 'Virginia',
    product_isSale: 'Yes',
    product_Price: '100.0000',
    product_Stock: '1',
    product_Description: 'Virginia City',
    image1: '',
    image2: '',
    image3: '',
    image4: '',
      ...
      <div className="photoContainer">
        <div className="photoGrid">
          <div className="productPhoto"> <img src={data.image1} alt="1" />
            <div className="uploadContainer"><DriveFolderUpload sx={{ fontSize: "20px" }} /> <input type="file" name="image1" onChange={handleImage} /> </div></div>
          <div className="productPhoto"><img src={data.image2} alt="2" />
            <div className="uploadContainer"><DriveFolderUpload sx={{ fontSize: "20px" }} /> <input type="file" name="image2" onChange={handleImage} /> </div></div>
          <div className="productPhoto"><img src={data.image3} alt="3" />
            <div className="uploadContainer"><DriveFolderUpload sx={{ fontSize: "20px" }} /> <input type="file" name="image3" onChange={handleImage} /> </div></div>
          <div className="productPhoto"><img src={data.image4} alt="4" />
            <div className="uploadContainer"><DriveFolderUpload sx={{ fontSize: "20px" }} /> <input type="file" name="image4" onChange={handleImage} /> </div></div>
        </div>
      </div>
      <div className="dataContainer">
        <div className="info_data">
          <div className="name"><h1> Name: {''} {data.product_Name}</h1></div>
          <div className="productInfo "><h3>Sale Status:</h3><span> {data.product_isSale}</span></div>
          <div className="productInfo "><h3> Product Price:</h3><span> Rp. {' '}{data.product_Price}</span></div>
          <div className="productInfo"><h3>Product Stock:</h3><span> {data.product_Stock} </span></div>
          <div className="productInfo "><h3>Product Category:</h3><span> {data.category_Name} {''} Benua </span></div>
        ...
        <form className="editProductForm" onSubmit={handleSubmit}>
          <div className="newproductItem">
            ...
            {server_error.product_Name ? (
              <label style={{ fontSize: 16, color: "red", paddingLeft: 10 }}>
                {server_error.product_Name[0]} </label>) : ("")}
          </div>
          <div className="newproductItem">
            ...
            <input type="text" name="product_Description"
              ...
              onChange={handleChange}
            />
            {server_error.product_Description ? (
              <label style={{ fontSize: 16, color: "red", paddingLeft: 10 }}>
                {server_error.product_Description[0]} </label>) : ("")}
          </div>
          <div className="newproductItem">
          ...
          <div className="newproductItem">
            ...
            {server_error.product_Stock ? (
              <label style={{ fontSize: 16, color: "red", paddingLeft: 10 }}>
                {server_error.product_Stock[0]}</label>) : ("")}
          </div>
          <div className="newproductItem">
