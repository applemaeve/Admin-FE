...
import { useDetaildOrderQuery } from '..//'; // Import  useDetaildOrderQuery hook
            ...
            <div className='contain' style={{ backgroundImage: `url(${backImg})` }}>
                ...
                <div className='orderDetails'>
                    <div className='leftHead'>
                        ...
                        <p className='spani'>Placement Date/Time: </p><br />
                        <p className='spani'>Delivery Charges: </p><br />
                    ...
                    <div className='rightvalue'>
                        ...
                        <p className='spani'>  Rp. {' '} {responseInfo.data.delivery_Charges} </p><br />
                        <p className='spani'> Rp. {' '}{responseInfo.data.total_Amount}</p><br />
                ...
                <div className='orderDetails'>
                    ...
                    <div className='deliverySection'>
                        ...
                        <div className='rightvalue'>
                            ...
                            <p className='spani'> Rp.. {' '}{responseInfo.data.payment.amount_Paid} </p><br />
                        </div>
                    </div>
                </div>
                <div className='sectionsHeading'>
